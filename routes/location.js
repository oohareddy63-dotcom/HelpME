...
if (accountSid && authToken) {
  try {
    ...
    console.warn('Twilio initialization failed in location routes:', err.message);
  }
}
...
router.post("/users", auth, async (req, res) => {
  ...
  try {
          ...
          try {
            client.messages
              .create({
                ...
                from: process.env.TWILIO_PHONE_NUMBER || "+12058461985", 
    ...
    if (client) {
      ...
      console.log('Twilio not configured - Emergency SMS disabled');
    }
